...
class WarehouseBypassController extends Controller
{
    public function tyreWarehouseBypass(Request $request) {
        ...
        return view('backend/warehouseBypass/tyre/index')->with('NUM_PAGE',$NUM_PAGE)
                                                         ->with('page',$page)
                                                         ->with('products',$products);
    }

    public function createTyreWarehouseBypass() {
        return view('backend/warehouseBypass/tyre/create-tyre');
    }
    ...
    public function addStockTyre(Request $request) {
        ...
        return redirect()->action('App\Http\Controllers\Backend\WarehouseBypassController@tyreWarehouseBypass');
    }
    ...
    public function deleteTyre($id){
        TyreWarehouseBypass::destroy($id);
        return redirect()->action('App\Http\Controllers\Backend\WarehouseBypassController@tyreWarehouseBypass');
    }

    public function editTyre($id){
      $product = TyreWarehouseBypass::findOrFail($id);
      return view('/backend/warehouseBypass/tyre/edit')->with('product', $product);
    }
