...
class WarehouseThaiwatsaduController extends Controller
{
    public function tyreWarehouseThaiwatsadu(Request $request) {
        ...
        return view('backend/warehouseThaiwatsadu/tyre/index')->with('NUM_PAGE',$NUM_PAGE)
                                                              ->with('page',$page)
                                                              ->with('products',$products);
    }

    public function createTyreWarehouseThaiwatsadu() {
        return view('backend/warehouseThaiwatsadu/tyre/create-tyre');
    }
    ...
    public function addStockTyre(Request $request) {
        ...
        return redirect()->action('App\Http\Controllers\Backend\WarehouseThaiwatsaduController@tyreWarehouseThaiwatsadu');
    }
    ...
    public function deleteTyre($id){
        TyreWarehouseThaiwatsadu::destroy($id);
        return redirect()->action('App\Http\Controllers\Backend\WarehouseThaiwatsaduController@tyreWarehouseThaiwatsadu');
    }

    public function editTyre($id){
      $product = TyreWarehouseThaiwatsadu::findOrFail($id);
      return view('/backend/warehouseThaiwatsadu/tyre/edit')->with('product', $product);
    }
