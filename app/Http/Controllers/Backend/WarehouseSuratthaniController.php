...
class WarehouseSuratthaniController extends Controller
{
    public function tyreWarehouseSuratthani(Request $request) {
        ...
        return view('backend/warehouseSuratthani/tyre/index')->with('NUM_PAGE',$NUM_PAGE)
                                                             ->with('page',$page)
                                                             ->with('products',$products);
    }

    public function createTyreWarehouseSuratthani() {
        return view('backend/warehouseSuratthani/tyre/create-tyre');
    }
    ...
    public function addStockTyre(Request $request) {
        ...
        return redirect()->action('App\Http\Controllers\Backend\WarehouseSuratthaniController@tyreWarehouseSuratthani');
    }
    ...
    public function deleteTyre($id){
        TyreWarehouseSuratthani::destroy($id);
        return redirect()->action('App\Http\Controllers\Backend\WarehouseSuratthaniController@tyreWarehouseSuratthani');
    }

    public function editTyre($id){
      $product = TyreWarehouseSuratthani::findOrFail($id);
      return view('/backend/warehouseSuratthani/tyre/edit')->with('product', $product);
    }
