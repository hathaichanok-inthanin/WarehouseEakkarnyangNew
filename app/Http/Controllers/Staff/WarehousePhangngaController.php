...
class WarehousePhangngaController extends Controller
{
    public function tyreWarehousePhangnga(Request $request) {
        ...
        return view('frontend/staff/warehousePhangnga/tyre/index')->with('NUM_PAGE',$NUM_PAGE)
                                                                  ->with('page',$page)
                                                                  ->with('products',$products);
    }

    public function createTyreWarehousePhangnga() {
        return view('frontend/staff/warehousePhangnga/tyre/create-tyre');
    }
    ...
    public function addStockTyre(Request $request) {
        ...
        return redirect()->action('App\Http\Controllers\Staff\WarehousePhangngaController@tyreWarehousePhangnga');
    }
    ...
    public function editTyre($id){
        ...
        return view('frontend/staff/warehousePhangnga/tyre/edit')->with('product', $product);
      }
