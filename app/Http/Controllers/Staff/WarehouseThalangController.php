...
class WarehouseThalangController extends Controller
{
    public function tyreWarehouseThalang(Request $request) {
        ...
        return view('frontend/staff/warehouseThalang/tyre/index')->with('NUM_PAGE',$NUM_PAGE)
                                                                 ->with('page',$page)
                                                                 ->with('products',$products);
    }

    public function createTyreWarehouseThalang() {
        return view('frontend/staff/warehouseThalang/tyre/create-tyre');
    }
    ...
    public function addStockTyre(Request $request) {
        ...
        return redirect()->action('App\Http\Controllers\Staff\WarehouseThalangController@tyreWarehouseThalang');
    }
    ...
    public function editTyre($id){
        ...
        return view('frontend/staff/warehouseThalang/tyre/edit')->with('product', $product);
    }
