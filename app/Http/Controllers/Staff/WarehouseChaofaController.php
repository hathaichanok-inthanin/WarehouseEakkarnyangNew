...
class WarehouseChaofaController extends Controller
{
    public function tyreWarehouseChaofa(Request $request) {
        ...
        return view('frontend/staff/warehouseChaofa/tyre/index')->with('NUM_PAGE',$NUM_PAGE)
                                                                ->with('page',$page)
                                                                ->with('products',$products);
    }

    public function createTyreWarehouseChaofa() {
        return view('frontend/staff/warehouseChaofa/tyre/create-tyre');
    }
    ...
    public function addStockTyre(Request $request) {
        ...
        return redirect()->action('App\Http\Controllers\Staff\WarehouseChaofaController@tyreWarehouseChaofa');
    }
    ...
    public function editTyre($id){
        ...
        return view('frontend/staff/warehouseChaofa/tyre/edit')->with('product', $product);
      }
