...
@section('content')
    <div class="container mt-5">
        ...
        <div class="row justify-content-center mt-3">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">เข้าสู่ระบบ ธุรกิจค้าส่ง</div>
                ...
                <h3 style="color: #ffffff;"> **สำหรับร้านยางที่ต้องการยางราคาส่ง เฉพาะพื้นที่จังหวัดภูเก็ต และพังงา
                    สามารถติดต่อได้ที่ 099-096-3624</h3>
                <h3 style="color: yellow; text-align: center;">( ไม่ต้องสต็อกยางก็มียางขาย ให้เอกการยางสต็อกยางแทนคุณ )</h3>
            </div>
        </div>
    </div>
@endsection
