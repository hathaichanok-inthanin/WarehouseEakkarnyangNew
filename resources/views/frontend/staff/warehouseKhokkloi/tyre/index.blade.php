        ...
        <div class="row">
            <div class="col-12">
                ...
                <center>
                    ...
                    @if ($warehouse_id == 'EKY01')
                        <a href="{{ url('/staff/create-tyre-warehouse-khokkloi') }}" class="btn btn-danger mt-3"><i
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <form action="{{ url('/staff/search/tyre-warehouse-khokkloi') }}" method="POST">
                            {{ csrf_field() }}
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <a class="btn btn-danger"
                                                                    href="{{ url('/staff/khokkloi/edit-tyre') }}/{{ $value->id }}">แก้ไขข้อมูล</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <div id="delete" class="modal fade">
                                    <div class="modal-dialog modal-dialog-centered modal-confirm">
                                        <div class="modal-content">
                                            ...
                                            <form action="{{ url('staff/khokkloi/delete-stock-tyre') }}" method="POST"
                                ...
                                <div id="add" class="modal fade">
                                    <div class="modal-dialog modal-dialog-centered modal-confirm">
                                        <div class="modal-content">
                                            ...
                                            <form action="{{ url('staff/khokkloi/add-stock-tyre') }}" method="POST"
                                                enctype="multipart/form-data" autocomplete="off">@csrf
                                                <div class="modal-body">
