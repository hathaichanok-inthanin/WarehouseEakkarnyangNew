...
@section('content')
    ...
    <div class="container-fluid mt--6">
        <div class="row">
            <div class="col-12">
                <h1 class="header-text text-center">คลังสินค้า สาขาเจ้าฟ้า</h1>
                <center>
                    <div class="col-md-3">
                    ...
                    @if ($warehouse_id == 'EKY03')
                        <a href="{{ url('/staff/create-tyre-warehouse-chaofa') }}" class="btn btn-danger mt-3"><i
                ...
                <!-- modal stock -->
                @php
                    $amount = DB::table('tyre_warehouse_chaofa')->sum('amount');
                    $amount_format = number_format($amount);
                    $stock = DB::table('tyre_warehouse_chaofa')->sum('stock');
                    $stock_format = number_format($stock);

                    $stock_sums = DB::table('tyre_warehouse_chaofa')
                        ->join('tyre_brands', 'tyre_warehouse_chaofa.brand_id', '=', 'tyre_brands.id')
                        ->select(
                            'tyre_brands.id as brand_id',
                            'tyre_brands.brand_name as brand_name',
                            DB::raw('SUM(tyre_warehouse_chaofa.amount) as sum'),
                        )
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <form action="{{ url('/staff/search/tyre-warehouse-chaofa') }}" method="POST">
                            {{ csrf_field() }}
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <a class="btn btn-danger"
                                                                    href="{{ url('/staff/chaofa/edit-tyre') }}/{{ $value->id }}">แก้ไขข้อมูล</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <div id="delete" class="modal fade">
                                    <div class="modal-dialog modal-dialog-centered modal-confirm">
                                        <div class="modal-content">
                                            ...
                                            <form action="{{ url('staff/chaofa/delete-stock-tyre') }}" method="POST"
                                ...
                                <div id="add" class="modal fade">
                                    <div class="modal-dialog modal-dialog-centered modal-confirm">
                                        <div class="modal-content">
                                            ...
                                            <form action="{{ url('staff/chaofa/add-stock-tyre') }}" method="POST"
                                                enctype="multipart/form-data" autocomplete="off">@csrf
                                                <div class="modal-body">
