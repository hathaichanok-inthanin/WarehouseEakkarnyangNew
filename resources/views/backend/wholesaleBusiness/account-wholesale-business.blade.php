...
@section('content')
    <div class="container-fluid mt--6">
        <div class="row">
            <div class="col-2"></div>
            <div class="col-8">
                <h1 class="header-text text-center">ข้อมูลธุรกิจค้าส่ง</h1>
                <div class="card">
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <a class="btn btn-danger"
                                                                    href="{{ url('/edit-account-wholesale-business') }}/{{ $value->id }}">แก้ไขข้อมูล</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                <button type="button" class="btn btn-info"
                                                                    data-dismiss="modal">ยกเลิก</button>
                                                                <a class="btn btn-danger"
                                                                    href="{{ url('/delete-account-wholesale-business') }}/{{ $value->id }}">ยืนยันการลบ</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
