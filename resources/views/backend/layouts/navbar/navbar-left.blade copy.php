          ...
          <div class="navbar-inner">
              ...
              <div class="collapse navbar-collapse" id="sidenav-collapse-main">
                  ...
                  <ul class="navbar-nav">
                      ...
                      <li class="nav-item">
                          <a class="nav-link active" href="#wholesale" data-toggle="collapse" role="button"
                      ...
                      <li class="nav-item">
                          <a class="nav-link active" href="#wholesalebusiness" data-toggle="collapse" role="button"
                      ...
                      <li class="nav-item">
                          <a class="nav-link active" href="#branchaccount" data-toggle="collapse" role="button"
                      ...
                      <li class="nav-item">
                          <a class="nav-link active" href="#adminaccount" data-toggle="collapse" role="button"
