...
@section('content')
    <div class="container-fluid mt--6">
        <div class="row">
            <div class="col-3"></div>
            <div class="col-6">
                <h1 class="header-text text-center">เพิ่มสินค้าใหม่เข้าคลังสาขาเจ้าฟ้า</h1>
                ...
                <div class="card">
                    <div class="card-header border-0">
                        <form method="POST" action="{{ url('create-tyre-warehouse-chaofa') }}" enctype="multipart/form-data">
                            @csrf
                            <div class="row mb-2">
                                @php
