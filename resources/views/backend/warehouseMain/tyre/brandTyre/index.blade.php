...
@section('content')
    @php
        $michelins = DB::table('tyre_warehouse_main')
            ->join('tyre_brands', 'tyre_warehouse_main.brand_id', '=', 'tyre_brands.id')
            ->select('tyre_brands.brand_name', 'tyre_warehouse_main.*')
            ->where('tyre_brands.brand_name', '=', 'MICHELIN')
            ->get();
        $bfgoodrichs = DB::table('tyre_warehouse_main')
            ->join('tyre_brands', 'tyre_warehouse_main.brand_id', '=', 'tyre_brands.id')
            ->select('tyre_brands.brand_name', 'tyre_warehouse_main.*')
            ->where('tyre_brands.brand_name', '=', 'BF Goodrich')
            ->get();
        $maxxiss = DB::table('tyre_warehouse_main')
            ->join('tyre_brands', 'tyre_warehouse_main.brand_id', '=', 'tyre_brands.id')
            ->select('tyre_brands.brand_name', 'tyre_warehouse_main.*')
            ->where('tyre_brands.brand_name', '=', 'MAXXIS')
            ->get();
        $otanis = DB::table('tyre_warehouse_main')
            ->join('tyre_brands', 'tyre_warehouse_main.brand_id', '=', 'tyre_brands.id')
            ->select('tyre_brands.brand_name', 'tyre_warehouse_main.*')
            ->where('tyre_brands.brand_name', '=', 'OTANI')
            ->get();
        $bridgestones = DB::table('tyre_warehouse_main')
            ->join('tyre_brands', 'tyre_warehouse_main.brand_id', '=', 'tyre_brands.id')
            ->select('tyre_brands.brand_name', 'tyre_warehouse_main.*')
            ->where('tyre_brands.brand_name', '=', 'BRIDGESTONE')
            ->get();
        $yokohamas = DB::table('tyre_warehouse_main')
            ->join('tyre_brands', 'tyre_warehouse_main.brand_id', '=', 'tyre_brands.id')
            ->select('tyre_brands.brand_name', 'tyre_warehouse_main.*')
            ->where('tyre_brands.brand_name', '=', 'YOKOHAMA')
            ->get();
        $toyos = DB::table('tyre_warehouse_main')
            ->join('tyre_brands', 'tyre_warehouse_main.brand_id', '=', 'tyre_brands.id')
            ->select('tyre_brands.brand_name', 'tyre_warehouse_main.*')
            ->where('tyre_brands.brand_name', '=', 'TOYO')
            ->get();
        $nittos = DB::table('tyre_warehouse_main')
            ->join('tyre_brands', 'tyre_warehouse_main.brand_id', '=', 'tyre_brands.id')
            ->select('tyre_brands.brand_name', 'tyre_warehouse_main.*')
            ->where('tyre_brands.brand_name', '=', 'NITTO')
            ->get();
        $goodyears = DB::table('tyre_warehouse_main')
            ->join('tyre_brands', 'tyre_warehouse_main.brand_id', '=', 'tyre_brands.id')
            ->select('tyre_brands.brand_name', 'tyre_warehouse_main.*')
            ->where('tyre_brands.brand_name', '=', 'GOODYEAR')
            ->get();
        $continentals = DB::table('tyre_warehouse_main')
            ->join('tyre_brands', 'tyre_warehouse_main.brand_id', '=', 'tyre_brands.id')
            ->select('tyre_brands.brand_name', 'tyre_warehouse_main.*')
            ->where('tyre_brands.brand_name', '=', 'CONTINENTAL')
            ->get();
        $others = DB::table('tyre_warehouse_main')
            ->join('tyre_brands', 'tyre_warehouse_main.brand_id', '=', 'tyre_brands.id')
            ->select('tyre_brands.brand_name', 'tyre_warehouse_main.*')
            ->where('tyre_brands.brand_name', '=', 'ยี่ห้ออื่นๆ')
            ->get();
        $pirellis = DB::table('tyre_warehouse_main')
            ->join('tyre_brands', 'tyre_warehouse_main.brand_id', '=', 'tyre_brands.id')
            ->select('tyre_brands.brand_name', 'tyre_warehouse_main.*')
            ->where('tyre_brands.brand_name', '=', 'PIRELLI')
            ->get();
        $raidens = DB::table('tyre_warehouse_main')
            ->join('tyre_brands', 'tyre_warehouse_main.brand_id', '=', 'tyre_brands.id')
            ->select('tyre_brands.brand_name', 'tyre_warehouse_main.*')
            ->where('tyre_brands.brand_name', '=', 'RAIDEN')
            ->get();
        $dunlops = DB::table('tyre_warehouse_main')
            ->join('tyre_brands', 'tyre_warehouse_main.brand_id', '=', 'tyre_brands.id')
            ->select('tyre_brands.brand_name', 'tyre_warehouse_main.*')
            ->where('tyre_brands.brand_name', '=', 'DUNLOP')
            ->get();
        $kumhos = DB::table('tyre_warehouse_main')
            ->join('tyre_brands', 'tyre_warehouse_main.brand_id', '=', 'tyre_brands.id')
            ->select('tyre_brands.brand_name', 'tyre_warehouse_main.*')
            ->where('tyre_brands.brand_name', '=', 'KUMHO')
            ->get();
        $westlakes = DB::table('tyre_warehouse_main')
            ->join('tyre_brands', 'tyre_warehouse_main.brand_id', '=', 'tyre_brands.id')
            ->select('tyre_brands.brand_name', 'tyre_warehouse_main.*')
            ->where('tyre_brands.brand_name', '=', 'WESTLAKE')
            ->get();
        $bigs = DB::table('tyre_warehouse_main')
            ->join('tyre_brands', 'tyre_warehouse_main.brand_id', '=', 'tyre_brands.id')
            ->select('tyre_brands.brand_name', 'tyre_warehouse_main.*')
            ->where('tyre_brands.brand_name', '=', 'ยางใหญ่')
            ->get();
    @endphp
                    ...
                    @foreach ($brands as $brand => $value)
                        <li class="nav-item">
                            <a href="{{ url('/brand-tyre') }}/{{ $value->brand_name }}"
                                class="nav-link mt-3">{{ $value->brand_name }}</a>
                        </li>
                    @endforeach
                </ul>
                {{-- end nav pills brand --}}
                        ...
                        <div class="row mb-2">
                            <div class="table-responsive">
                                <table class="table align-items-center table-flush">
                                    ...
                                    @elseif($brand_name == 'BF Goodrich')
                                        <tbody class="list">
                                            @foreach ($bfgoodrichs as $bfgoodrich => $value)
                                                @php
                                                    $brand = DB::table('tyre_brands')
                                                        ->where('id', $value->brand_id)
                                                        ->value('brand_name');
                                    ...
                                    @elseif($brand_name == 'DUNLOP')
                                        <tbody class="list">
                                            @foreach ($dunlops as $dunlop => $value)
                                                @php
                                                    $brand = DB::table('tyre_brands')
                                                        ->where('id', $value->brand_id)
                                                        ->value('brand_name');
                                    ...
                                    @elseif($brand_name == 'WESTLAKE')
                                        <tbody class="list">
                                            @foreach ($westlakes as $westlake => $value)
                                                @php
                                                    $brand = DB::table('tyre_brands')
                                                        ->where('id', $value->brand_id)
                                                        ->value('brand_name');
                                    ...
                                    @elseif($brand_name == 'ยางใหญ่')
                                        <tbody class="list">
                                            @foreach ($bigs as $big => $value)
                                                @php
                                                    $brand = DB::table('tyre_brands')
                                                        ->where('id', $value->brand_id)
                                                        ->value('brand_name');
