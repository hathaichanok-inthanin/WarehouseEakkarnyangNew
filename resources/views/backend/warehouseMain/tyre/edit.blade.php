            ...
            <div class="col-6">
                ...
                <div class="card">
                    <div class="card-header border-0">
                        <form method="POST" action="{{ url('main/update-tyre') }}" enctype="multipart/form-data">
                            @csrf
                            <div class="row mb-2">
                                @php
                                ...
                                <div class="col-md-12">
                                    ...
                                    <select name="brand_id" class="form-control">
                                        ...
                                        @foreach ($brands as $brand => $value)
                                            <option value="{{ $value->id }}">{{ $value->id }}{{ $value->brand_name }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="col-md-12">
                                    ...
                                    <select name="model_id" class="form-control">
                                        ...
                                        @foreach ($models as $model => $value)
                                            <option value="{{ $value->id }}">{{ $value->id }}{{ $value->model }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <label class="col-form-label">ราคาต้นทุนส่ง
                                        @if ($errors->has('cost'))
                                            <span class="text-danger"
                                                style="font-size: 15px;">({{ $errors->first('cost') }})</span>
                                        @endif
                                    </label>
                                ...
                                <div class="col-md-12">
                                    <label class="col-form-label">หมายเหตุ
                                        @if ($errors->has('comment'))
                                            <span class="text-danger"
                                                style="font-size: 15px;">({{ $errors->first('comment') }})</span>
                                        @endif
                                    </label>
