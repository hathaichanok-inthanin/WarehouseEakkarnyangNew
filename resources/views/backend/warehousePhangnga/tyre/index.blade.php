...
@section('content')
    <div class="container-fluid mt--6">
        <div class="row">
            <div class="col-12">
                <h1 class="header-text text-center">คลังสินค้า สาขาเมืองพังงา</h1>
                <center>
                    <div class="col-md-3">
                    ...
                    <a href="{{ url('/create-tyre-warehouse-phangnga') }}" class="btn btn-danger mt-3"><i
                ...
                <!-- modal stock -->
                @php
                    $amount = DB::table('tyre_warehouse_phangnga')->sum('amount');
                    $amount_format = number_format($amount);
                    $stock = DB::table('tyre_warehouse_phangnga')->sum('stock');
                    $stock_format = number_format($stock);

                    $stock_sums = DB::table('tyre_warehouse_phangnga')
                        ->join('tyre_brands', 'tyre_warehouse_phangnga.brand_id', '=', 'tyre_brands.id')
                        ->select(
                            'tyre_brands.id as brand_id',
                            'tyre_brands.brand_name as brand_name',
                            DB::raw('SUM(tyre_warehouse_phangnga.amount) as sum'),
                        )
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <form action="{{ url('/search/tyre-warehouse-phangnga') }}" method="POST">
                            {{ csrf_field() }}
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <a class="btn btn-danger"
                                                                    href="{{ url('/phangnga/edit-tyre') }}/{{ $value->id }}">แก้ไขข้อมูล</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                <button type="button" class="btn btn-info"
                                                                    data-dismiss="modal">ยกเลิก</button>
                                                                <a class="btn btn-danger"
                                                                    href="{{ url('/phangnga/delete-tyre') }}/{{ $value->id }}">ยืนยันการลบ</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <div id="delete" class="modal fade">
                                    <div class="modal-dialog modal-dialog-centered modal-confirm">
                                        <div class="modal-content">
                                            ...
                                            <form action="{{ url('/phangnga/delete-stock-tyre') }}" method="POST"
                                ...
                                <div id="add" class="modal fade">
                                    <div class="modal-dialog modal-dialog-centered modal-confirm">
                                        <div class="modal-content">
                                            ...
                                            <form action="{{ url('/phangnga/add-stock-tyre') }}" method="POST"
                                                enctype="multipart/form-data" autocomplete="off">@csrf
                                                <div class="modal-body">
