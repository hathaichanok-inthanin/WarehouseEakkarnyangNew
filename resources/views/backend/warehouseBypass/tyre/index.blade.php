        ...
        <div class="row">
            <div class="col-12">
                ...
                <center>
                    ...
                    <a href="{{ url('/create-tyre-warehouse-bypass') }}" class="btn btn-danger mt-3"><i
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <form action="{{ url('/search/tyre-warehouse-bypass') }}" method="POST">
                            {{ csrf_field() }}
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <a class="btn btn-danger"
                                                                    href="{{ url('/bypass/edit-tyre') }}/{{ $value->id }}">แก้ไขข้อมูล</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                <button type="button" class="btn btn-info"
                                                                    data-dismiss="modal">ยกเลิก</button>
                                                                <a class="btn btn-danger"
                                                                    href="{{ url('/bypass/delete-tyre') }}/{{ $value->id }}">ยืนยันการลบ</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <div id="delete" class="modal fade">
                                    <div class="modal-dialog modal-dialog-centered modal-confirm">
                                        <div class="modal-content">
                                            ...
                                            <form action="{{ url('/bypass/delete-stock-tyre') }}" method="POST"
                                ...
                                <div id="add" class="modal fade">
                                    <div class="modal-dialog modal-dialog-centered modal-confirm">
                                        <div class="modal-content">
                                            ...
                                            <form action="{{ url('/bypass/add-stock-tyre') }}" method="POST"
                                                enctype="multipart/form-data" autocomplete="off">@csrf
                                                <div class="modal-body">
