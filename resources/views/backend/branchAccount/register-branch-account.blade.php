...
@section('content')
    <div class="container-fluid mt--6">
        <div class="row">
            <div class="col-3"></div>
            <div class="col-6">
                <h1 class="header-text text-center">ลงทะเบียนผู้ใช้งานสาขาใหม่</h1>
                ...
                <div class="card">
                    <div class="card-header border-0">
                        <form method="POST" action="{{ url('register-branch-account') }}" enctype="multipart/form-data">
                            @csrf
                            <h3 class="mb-0">กรอกข้อมูลเพื่อลงทะเบียนผู้ใช้งานสาขาใหม่</h3>
                            <div class="row mb-2">
                                <div class="col-md-12">
