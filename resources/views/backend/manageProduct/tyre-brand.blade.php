...
@section('content')
    <div class="container-fluid mt--6">
        <div class="row">
            <div class="col-3"></div>
            <div class="col-6">
                <h1 class="header-text text-center">จัดการข้อมูลยี่ห้อยางรถยนต์</h1>
                ...
                <div class="card">
                    <div class="card-header border-0">
                        <form method="POST" action="{{ url('create-tyre-brand') }}" enctype="multipart/form-data">
                            @csrf
                                ...
                                <table class="table align-items-center table-flush">
                                    ...
                                    <tbody class="list">
                                        @foreach ($tyre_brands as $tyre_brand => $value)
                                            <tr>
                                                <td>{{ $NUM_PAGE * ($page - 1) + $tyre_brand + 1 }}</td>
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                                            <a class="dropdown-item" data-toggle="modal"
                                                                href="#editBrand{{ $value->id }}">แก้ไข</a>
                                                            <a class="dropdown-item" data-toggle="modal"
                                                                href="#deleteBrand{{ $value->id }}">ลบ</a>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
                                            <!-- Modal Delete Brand -->
                                            <div id="deleteBrand{{ $value->id }}" class="modal fade">
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <a class="btn btn-danger"
                                                                href="{{ url('/delete-tyre-brand') }}/{{ $value->id }}">ยืนยันการลบ</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            <button type="button" class="btn btn-info"
                                                                data-dismiss="modal">ยกเลิก</button>
                                                            <a class="btn btn-danger"
                                                                href="{{ url('/edit-tyre-brand') }}/{{ $value->id }}">แก้ไขข้อมูล</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
